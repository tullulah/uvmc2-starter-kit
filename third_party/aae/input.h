...
#define INPUT_START1 ((currentButtonState & 8) != 0)   /* VPy standard: btn4 = Start (was btns 1+2) */
...
#define INPUT_TEST 0
#define INPUT_COIN1 ((currentButtonState & 4) != 0)   /* VPy standard: btn3 = Coin (was btns 3+4) */

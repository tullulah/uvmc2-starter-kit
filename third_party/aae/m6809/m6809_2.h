...
extern unsigned char *m6809_2_readHandler;
#include "../aae_memdispatch.h"
#include "../aae_access_count.h"
#define M6809_2_RDMEM(A) (AAE_CNT(aae_acc_rd, 1, (A)), aae_rd_byte(m6809_2_readHandler, (A)))
...
extern unsigned char *m6809_2_writeHandler;
#define M6809_2_WRMEM(A,V) (AAE_CNT(aae_acc_wr, 1, (A)), aae_wr_byte(m6809_2_writeHandler, (A), (V)))
...
/****************************************************************************/
#define M6809_2_RDOP(A) (AAE_CNT(aae_acc_op, 1, (A)), ROM[A])
...
#define M6809_2_RDOP_ARG(A) (AAE_CNT(aae_acc_ar, 1, (A)), RAM[A])
